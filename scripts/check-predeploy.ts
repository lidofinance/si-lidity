...
async function mainnetExample() {
  ...
  console.log("GasPriceOracle exists in l1 chain type?", gasPriceOracleCode !== "0x");
}
...
async function opExample() {
  ...
  console.log("GasPriceOracle exists in optimism chain type?", gasPriceOracleCode !== "0x");
}
