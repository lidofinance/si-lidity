...
| `function getTotalShares() external view returns (uint256)`      | Returns the total amount of shares in existence. [More here](https://docs.lido.fi/contracts/lido/#gettotalshares)                                                                |
